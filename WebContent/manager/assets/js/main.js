...
if ($(document).ready(function () {
    localStorage.getItem("fixedTop") && ($(".navbar-top").addClass("fixed"), $("#fixed-navbar").prop("checked", !0)),
    ...
    "" != localStorage.getItem("fixedsiderbar") && ($(".navbar-top, .navbar-side, #page-wrapper, .breadcrumbs").addClass("fixed"), $("#fixed-sidebar").prop("checked", !0), $("#fixed-navbar").prop("checked", !0)),
    ...
    localStorage.getItem("sidetoggle") && ($(".navbar-side, #page-wrapper, .footer-inner, .breadcrumbs").addClass("collapsed"), $("#sidebar-toggle").prop("checked", !0)),
    ...
    localStorage.getItem("insidecontainer") && ($("#main-container, .navbar-top").addClass("container"), $("#in-container").prop("checked", !0)),
    ...
    localStorage.getItem("SideBarLight") && ($(".navbar-side").addClass("sidebar-light"), $("#side-bar-color").prop("checked", !0)),
    ...
    $(function () {
        function e() {
            ...
            jQuery(window).width() < 991 ? $(".sidebar-collapse").css("max-height", windowHeight - 110) : $(".navbar-side").hasClass("fixed") ? $(".sidebar-collapse").css("max-height", windowHeight) : $(".sidebar-collapse").css("max-height", 5e3)
}
        e(),
    ...
    function () {
        var e = $(this).attr("id");
        $('a[href="#' + e + '"]').closest(".panel-heading").addClass("accordion-active"),
        $('a[href="#' + e + '"] .panel-title span').html('<i class="fa fa-angle-down bigger-110"></i>')
}),
    $(".collapse").on("hide.bs.collapse",
    function () {
        var e = $(this).attr("id");
        $('a[href="#' + e + '"]').closest(".panel-heading").removeClass("accordion-active"),
        $('a[href="#' + e + '"] .panel-title span').html('<i class="fa fa-angle-right bigger-110"></i>')
}),
    $(".toggle").on("click",
    function () {
        var e = $("#" + $(this).data("toggle"));
        return e.is(":visible") ? e.addClass("hide").removeClass("show") : e.addClass("show").removeClass("hide"),
        !1
}),
...
function (e) {
    ...
    init: function () {
            ...
            t.find("li.open").has("ul").children("ul").addClass("collapse in"),
            t.find("li").not(".open").has("ul").children("ul").addClass("collapse"),
            t.find("li").has("ul").children("a").on("click",
            function (t) {
                t.preventDefault(),
                e(this).parent("li").toggleClass("open").children("ul").collapse("toggle"),
                n && e(this).parent("li").siblings().removeClass("open").children("ul.in").collapse("hide")
})
}
},
    e.fn[n] = function (a) {
        return this.each(function () {
            e.data(this, "plugin_" + n) || e.data(this, "plugin_" + n, new t(this, a))
})
}
...
var App = function () {
    var e = [];
    if ("webkitSpeechRecognition" in window) var t = new webkitSpeechRecognition;
    var n = function (n) {
        if ("webkitSpeechRecognition" in window) if ("start" == n) t.start();
        else if ("stop" == n) t.stop();
        else {
            var a = {
                continuous: !0,
                interim: !0,
            ...
            $.extend(a, n),
            a.continuous && (t.continuous = !0),
            a.interim && (t.interimResults = !0),
            a.lang && (t.lang = a.lang);
            var o = !1,
            i = "";
            t.onresult = function (t) {
                for (var n = t.resultIndex; n < t.results.length; ++n) if (t.results[n].isFinal) {
                    var s = t.results[n][0].transcript;
                    s = s.toLowerCase(),
                    s = s.replace(/^\s+|\s+$/g, ""),
                    console.log(s),
                    a.onResult && a.onResult(s),
                    $.each(e,
                    function (e, t) {
                        o ? i == t.command && (t.dictation ? s == t.dictationEndCommand ? (o = !1, t.dictationEnd(s)) : t.listen(s) : (o = !1, t.listen(s))) : t.command == s && (t.action(s), t.listen && (o = !0, i = t.command))
                    })
                } else {
                    var l = t.results[n][0].transcript;
                    $.each(e,
                    function (e, t) {
                        t.interim !== !1 && o && i == t.command && t.interim(l)
                    })
                }
            },
    ...
    a = function (t, n) {
        ...
        t ? a.action ? e.push({
            ...
            dictationEnd: a.dictationEnd,
            dictationEndCommand: a.dictationEndCommand,
            interim: a.interim,
            action: a.action,
            listen: a.listen
